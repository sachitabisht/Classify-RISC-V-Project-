...
class TestAbsLoss(unittest.TestCase):
    ...
    def test_abs_loss_invalid_n(self):
        ...
        # set a2 to invalid length of array
        t.input_scalar("a2", 0)
        # call the 'abs_loss' function
        t.call('abs_loss')
        t.execute(code=36)
...
class TestInitializeZero(unittest.TestCase):
    ...
    def test_malloc_fail(self):
        self.test_simple(fail="malloc", code=26)
